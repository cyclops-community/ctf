...
//      this->["ij"] = t_dns["ij"];
  ...
  void tensor::conv_type(tensor * B){
    ...
    B->operator[](str) = Function<dtype_A,dtype_B>([](dtype_A a){ return (dtype_B)a; })(this->operator[](str));
  ...
  void tensor::compare_elementwise(tensor * A, tensor * B){
    ...
    switch (sr->el_size){
      case sizeof(bool): //bool
        this->operator[](str) = Function<dtype,dtype,bool>([](dtype a, dtype b){ return a==b; })(A->operator[](str),B->operator[](str));
        break;

 /*     case sizeof(int): //int
        this->operator[](str) = Function<dtype,dtype,int>([](dtype a, dtype b){ return (int)(a==b); })(A->operator[](str),B->operator[](str));
        break;

      case sizeof(int64_t): //int64_t
        this->operator[](str) = Function<dtype,dtype,int64_t>([](dtype a, dtype b){ return (int64_t)(a==b); })(A->operator[](str),B->operator[](str));
        break;
*/
      default:
        ABORT;
