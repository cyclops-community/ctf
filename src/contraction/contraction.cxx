...
namespace CTF_int {
  ...
  int contraction::sym_contract(){
    ...
    CTF_alloc_ptr(sizeof(int)*C->order,          (void**)&map_C);
    CTF_alloc_ptr(sizeof(int*)*C->order,         (void**)&dstack_map_C);
    CTF_alloc_ptr(sizeof(tensor*)*C->order,      (void**)&dstack_tsr_C);
