...
namespace CTF_int {
   ...
   * \param[in] func function (or NULL) to apply to right operand
   */
  int spA_dnB_seq_sum(char const *            alpha,
                      char const *            A,
                      int64_t                 size_A,
                      algstrct const *        sr_A,
                      char const *            beta,
   ...
   * \param[in] func function (or NULL) to apply to right operand
   */
  int dnA_spB_seq_sum(char const *            alpha,
                      char const *            A,
                      algstrct const *        sr_A,
                      int                     order_A,
