...
class cCTF_Tensor {
  ...
  public:
     ...
     */
    void sum(const std::complex<double> alpha, const cCTF_Tensor& A, const char * idx_A,
             const std::complex<double> beta,                       const char * idx_B);
     ...
     */
    std::complex<double> * get_raw_data(int * size);
     ...
     */
    const std::complex<double> * raw_data(int * size) const;
     ...
     */
    cCTF_Tensor& operator=(const std::complex<double> val);
